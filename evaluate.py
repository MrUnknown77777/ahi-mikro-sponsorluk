...
def main() -> None:
    ...
    print(f"  altın standart  her brif için 30 ilgili üretici (niş eşleşmesi)")
    print()
    ...
    print("  verisinde düşmesi beklenir. Recall@50 tavana yakındır çünkü 900 profillik")
    print("  havuzda brif başına 30 ilgili üretici bulunmaktadır.")
    print()
